                    ...
                    <div className="grid grid-cols-12 gap-2">
                        <div className="col-span-6">
                            <div className="sliderContent1 text-white mt-52">
                                ...
                                <h1 className="sliderTitle pb-4 font-NotoSans sliderTitle text-[58px] font-bold">I'm <span className='text-primaryTextColor'>Tahfeez Mizan </span>Mern Stack Developer</h1>
